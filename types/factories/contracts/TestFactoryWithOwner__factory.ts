...
import type {
  TestFactoryWithOwner,
  TestFactoryWithOwnerInterface,
} from "../../contracts/TestFactoryWithOwner";
...
type TestFactoryWithOwnerConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: TestFactoryWithOwnerConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class TestFactoryWithOwner__factory extends ContractFactory {
  constructor(...args: TestFactoryWithOwnerConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): TestFactoryWithOwner__factory {
    return super.connect(runner) as TestFactoryWithOwner__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): TestFactoryWithOwnerInterface {
    return new Interface(_abi) as TestFactoryWithOwnerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as TestFactoryWithOwner;
  }
}
