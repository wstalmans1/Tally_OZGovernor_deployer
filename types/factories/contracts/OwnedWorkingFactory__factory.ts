...
import type {
  OwnedWorkingFactory,
  OwnedWorkingFactoryInterface,
} from "../../contracts/OwnedWorkingFactory";
...
type OwnedWorkingFactoryConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: OwnedWorkingFactoryConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class OwnedWorkingFactory__factory extends ContractFactory {
  constructor(...args: OwnedWorkingFactoryConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): OwnedWorkingFactory__factory {
    return super.connect(runner) as OwnedWorkingFactory__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): OwnedWorkingFactoryInterface {
    return new Interface(_abi) as OwnedWorkingFactoryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as OwnedWorkingFactory;
  }
}
