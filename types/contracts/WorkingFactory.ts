...
export interface WorkingFactoryInterface extends Interface {
...
export interface WorkingFactory extends BaseContract {
  connect(runner?: ContractRunner | null): WorkingFactory;
  waitForDeployment(): Promise<this>;

  interface: WorkingFactoryInterface;
