...
export interface TestFactoryWithOwnerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "deploy"
      | "owner"
...
export interface TestFactoryWithOwner extends BaseContract {
  connect(runner?: ContractRunner | null): TestFactoryWithOwner;
  waitForDeployment(): Promise<this>;

  interface: TestFactoryWithOwnerInterface;
