...
export interface OwnedWorkingFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "deploy"
      | "owner"
...
export interface OwnedWorkingFactory extends BaseContract {
  connect(runner?: ContractRunner | null): OwnedWorkingFactory;
  waitForDeployment(): Promise<this>;

  interface: OwnedWorkingFactoryInterface;
